...
const Footer = () => {
    return (
        <div className="text-center bg-gray-900 text-white p-10 pb-0">
         <div className='md:flex md:justify-around md:gap-10'>
          {/* Prodcut section  */}
         <div className="">
        <h6 className="uppercase font-semibold mb-4 text-2xl  text-center md:text-xl ">
          Products
        </h6>
        <p className="mb-4">
       ...
       {/* contact section  */}
          <div className="">
        <h6 className="uppercase font-semibold mt-8 mb-4 text-2xl text-center md: flex md:mt-0 md:text-xl">
          Contact
        </h6>
    ...
    {/* social media section  */}
      ...
      <h4>Get connected with us on social networks:</h4>
        ...
        <div className="text-center p-4" style={{backgroundColor: "rgba(0, 0, 0, 0.2)"}}>
          2021  © Copyright
          <a className="text-white" href="https://tailwind-elements.com/"> MobileHub</a>
        </div>
      </div>
    );
};
